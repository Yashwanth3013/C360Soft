							...
							<div className="row servicecol height350">
								<div className="col-md-4">
									<div className="servicebox wow fadeInUp animated">
										...
										<p><Link to="/Artificialintelligencepage1">Read More</Link> </p>
									</div>
								</div>
								<div className="col-md-4">
									<div className="servicebox wow fadeInUp animated">
							...
							<div className="row servicecol">
								<div className="col-md-4">
									<div className="servicebox">
										...
										<p><Link to="/Applicationservicespage">Read More</Link> </p>
									</div>
								</div>
								<div className="col-md-4">
									<div className="servicebox">
							...
							<div className="row servicecol height350">
								<div className="col-md-4">
									<div className="servicebox">
										...
										<p><Link to="/Cloudservicespage">Read More</Link> </p>
									</div>
								</div>
								<div className="col-md-4">
									<div className="servicebox">
							...
							<div className="row servicecol">
								<div className="col-md-4">
									<div className="servicebox">
										...
										<h4>DevOps</h4>
										<p>Streamline IT by bringing business, development and operations teams together and applying automated processes. </p>
										<p><Link to="/Devopspage1">Read More</Link> </p>
									</div>
								</div>
							</div>
						</div>
							...
							<div className="row servicecol">
								<div className="col-md-4">
									<div className="servicebox">
										...
										<p><Link to="/Digitaltransformationpage">Read More</Link> </p>
									</div>
								</div>
								<div className="col-md-4">
									<div className="servicebox">
										...
										<p><Link to="/Digitaltransformation">Read More</Link> </p>
									</div>
								</div>
								<div className="col-md-4">
									<div className="servicebox">
							...
							<div className="row servicecol height350">
								<div className="col-md-4">
									<div className="servicebox">
										...
										<p><Link to="/Digitalanalyticspage">Read More</Link> </p>
									</div>
								</div>
								<div className="col-md-4">
									<div className="servicebox">
